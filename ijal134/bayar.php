                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                    <?php
                                        $ambilsemuadatastock = mysqli_query($conn, "select * from bayar m, stock s where s.idtim = m.idtim");
  ...
  <div class="modal fade" id="myModal">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <br>
        <button type="submit" class="btn btn-primary" name="databayar">Submit</button>
        </div>
        </form>
