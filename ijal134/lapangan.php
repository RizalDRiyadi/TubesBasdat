                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">nilai lapangan</li>
                        </ol>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                    <?php
                                        $ambilsemuadatastock = mysqli_query($conn, "select * from lapangan l, stock s where s.idtim = l.idtim");
                                        ...
                                        <tr>
                                         ...
                                         <div class="modal fade" id="edit<?=$idb;?>">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <button type="submit" class="btn btn-primary" name="editbayar">Edit</button>
                                                    </div>
                                                    </form>
      ...
      <div class="modal-content">
        ...
        <select name="datanya" class="form-control">
            ...
            while($fetcharray = mysqli_fetch_array($ambilsemuadatanya)){
                $namatimnya = $fetcharray['namatim'];
                $idtimnya = $fetcharray['idtim'];
            ?>

            <option value="<?=$idtimnya;?>"><?=$namatimnya;?></option>
        ...
        <br>
        <input type="text" name="komentar" placeholder="Komentar" class="form-control" required>
        <br>
        <button type="submit" class="btn btn-primary" name="datalapangan">Submit</button>
        </div>
        </form>
